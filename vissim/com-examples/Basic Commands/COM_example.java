...
// This scrips demonstrates how to use the COM interface in Java.
...
// languages VBA, Python, Matlab and C++.
...
public class COM_example
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        ActiveXComponent vissim = new ActiveXComponent("VISSIM.Vissim.700");
        // Load example net
        String pathOfComExample = "C:\\Users\\Public\\Documents\\PTV Vision\\PTV Vissim 7\\Examples Training\\COM\\Basic Commands\\";
        vissim.invoke("LoadNet", pathOfComExample + "COM_example.inpx");
        // Load layout
        vissim.invoke("LoadLayout", pathOfComExample + "COM_example.layx");
        ...
        int svrdNumber = 1; // SVRD = Static Vehicle Routing Desision
        int svrNumber = 1; // SVR = Static Vehicle Route (of a specific Static Vehicle Routing Desision)
        ...
        // Changing the disired speeed distribution
        ...
        simBreakAt = 198; // Simulationsecond [s] 
        Dispatch.invoke(simulation, "AttValue", Dispatch.Put, new Object[]{"SimBreakAt", simBreakAt}, new int[1]);
        ...
        String stateOfSh = signalHead.invoke("AttValue", "State").getString();

        System.out.println("Actual state of SignalHead(" + shNumber + ") is: " + stateOfSh);// possible output: 'GREEN', 'RED', 'AMBER', 'REDAMBER'
        ...
        String newState = "GREEN"; //possible values: "GREEN", "RED", "AMBER", "REDAMBER"
        Dispatch.invoke(signalGroup, "AttValue", Dispatch.Put, new Object[]{"State", newState}, new int[1]);
        ...
        simBreakAt = 200; // Simulationsecond [s]
        Dispatch.invoke(simulation, "AttValue", Dispatch.Put, new Object[]{"SimBreakAt", simBreakAt}, new int[1]);
        ...
        // Method #2: Loop over all Vehicles using Object Enumeration
        System.out.println("Loop over all Vehilces (Enumeration):");
        ...
        System.out.println("Get Vehicle-Attribtues (MultiAttValues):");
         ...
         * COM_example_utils class offers a simple approach to read complete
        ...
        int[][] vehicleNumbers = COM_example_utils.get2DIntArrayFromSafeArray(vnsarray);
        String[][] vehicleTypes = COM_example_utils.get2DStringArrayFromSafeArray(vtsarray);
        double[][] vehicleSpeeds = COM_example_utils.get2DDoubleArrayFromSafeArray(vssarray);
        double[][] vehiclePositions = COM_example_utils.get2DDoubleArrayFromSafeArray(vpsarray);
        String[][] vehicleLinklanes = COM_example_utils.get2DStringArrayFromSafeArray(vlsarray);
        ...
        endOfSimulation = 600;
        Dispatch.invoke(simulation, "AttValue", Dispatch.Put, new Object[]{"SimPeriod", endOfSimulation}, new int[1]);
        simBreakAt = 0; // Simulationsecond [s] => 0 means no break! 
        Dispatch.invoke(simulation, "AttValue", Dispatch.Put, new Object[]{"SimBreakAt", simBreakAt}, new int[1]);
        ...
        System.out.println("Average travel time all time intervalls of all simulation of all vehicle classes: " + traveltime
        ...
        System.out.println("Maximum travel time of all time intervalls of the current simulation of vehicle class HGV: "
        ...
        System.out.println("Data Collection #" + dcMeasurementNr
                + ": Average values of all Simulations runs of 1st time intervall of all vehicle classes:");
        ...
        // Saving
        //==========================================================================
        String filename = pathOfComExample + "COM_example_saved.inpx";
        vissim.invoke("SaveNetAs", filename);
        
        filename = pathOfComExample + "COM_example_saved.layx";
