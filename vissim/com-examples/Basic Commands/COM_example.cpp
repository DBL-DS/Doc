...
// This scrips demonstrates how to use the COM interface in C++.
...
// languages VBA, Python, C# and Matlab.
...
#import "C:\\Program Files\\PTV Vision\\PTV Vissim 7\\Exe\\Vissim.exe" rename_namespace ("VISSIMLIB") 
...
int main(int argc, char* argv[])
{
	...
	CoInitialize(NULL);
	{
		...
		// Vissim.CreateInstance('Vissim.Vissim-32.600'); //Vissim 6 - 32 bit
		// Vissim.CreateInstance('Vissim.Vissim-64.600'); //Vissim 6 - 64 bit
		// Vissim.CreateInstance('Vissim.Vissim-32.700'); //Vissim 7 - 32 bit
		// Vissim.CreateInstance('Vissim.Vissim-64.700'); //Vissim 7 - 64 bit

		bstr_t Path_of_COM_example_network = "C:\\Users\\Public\\Documents\\PTV Vision\\PTV Vissim 7\\Examples Training\\COM\\Basic Commands\\"; // always use \\ at the end

		// Load a Vissim Network :
		bstr_t Filename = Path_of_COM_example_network + "COM_example.inpx";
		cout << Filename << endl;
		...
		VehCompRelFlow->PutAttValue("DesSpeedDistr", 30); // Changing the disired speeed distribution
		...
		//// Direct method also possible also possible (without safearray):
		...
		bstr_t State_of_SH = Vissim->Net->SignalHeads->GetItemByKey(SH_number)->GetAttValue("State"); // possible output : 'GREEN', 'RED', 'AMBER', 'REDAMBER'
		...
		bstr_t new_state = "GREEN"; //possible values: "GREEN", "RED", "AMBER", "REDAMBER"
		SignalGroup->PutAttValue("State", new_state);
		...
		cout << "Average travel time all time intervalls of all simulation of all vehicle classes: " << TT << "(number of vehicles: " << No_Veh << ")" << endl;
		...
		cout << "Maximum travel time of all time intervalls of the current simulation of vehicle class HGV: " << TT << "(number of vehicles: " << No_Veh << ")" << endl;
		...
		cout << "Data Collection #" << DC_measurement_number << ": Average values of all Simulations runs of 1st time intervall of all vehicle classes:" << endl;
